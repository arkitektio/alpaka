...
from alpaka.funcs import asubscribe, execute, aexecute, subscribe
...
class LLMModelFilter(BaseModel):
    ...
    ids: Optional[Tuple[ID, ...]] = None
    search: Optional[str] = None
    input_modalities: Optional[Tuple[InputModality, ...]] = Field(
        alias="inputModalities", default=None
    )
    output_modalities: Optional[Tuple[InputModality, ...]] = Field(
        alias="outputModalities", default=None
    )
...
class RoomFilter(BaseModel):
    ...
    search: Optional[str] = None
    ids: Optional[Tuple[ID, ...]] = None
    talking_about: Optional["StructureInput"] = Field(
        alias="talkingAbout", default=None
    )
...
class ListMessage(BaseModel):
    ...
    attached_structures: Tuple[ListMessageAttachedstructures, ...] = Field(
        alias="attachedStructures"
    )
    "The collections that can be embedded with this model"
    model_config = ConfigDict(frozen=True)
...
class Message(BaseModel):
    ...
    attached_structures: Tuple[MessageAttachedstructures, ...] = Field(
        alias="attachedStructures"
    )
    "The collections that can be embedded with this model"
    model_config = ConfigDict(frozen=True)
...
class GenerateImageMutationGenerateimage(BaseModel):
    ...
    typename: Literal["ImageReponse"] = Field(
        alias="__typename", default="ImageReponse", exclude=True
    )
    image: str
    model_config = ConfigDict(frozen=True)
...
class SearchMessagesQuery(BaseModel):
    ...
    class Meta:
        ...
        document = "query SearchMessages($search: String, $values: [ID!]) {\n  options: messages(\n    filters: {search: $search, ids: $values}\n    pagination: {limit: 10}\n  ) {\n    value: id\n    label: title\n    __typename\n  }\n}"
...
class ListMessagesQuery(BaseModel):
    ...
    class Meta:
        ...
        document = "fragment ListMessage on Message {\n  id\n  text\n  agent {\n    id\n    __typename\n  }\n  attachedStructures {\n    object\n    identifier\n    __typename\n  }\n  __typename\n}\n\nquery ListMessages($filter: MessageFilter, $pagination: OffsetPaginationInput) {\n  messages(filters: $filter, pagination: $pagination) {\n    ...ListMessage\n    __typename\n  }\n}"
...
async def achat(
    ...
    model: Optional[IDCoercible] = None,
...
async def agenerate_image(
    ...
    return (
        await aexecute(
            ...
            {"input": {"model": model, "description": description}},
            rath=rath,
        )
    ).generate_image
...
async def aget_chroma_collection(
    id: ID, rath: Optional[AlpakaRath] = None
) -> ChromaCollection:
    """GetChromaCollection
...
async def aget_message(id: ID, rath: Optional[AlpakaRath] = None) -> Message:
    ...
    Returns:
        Message
    """
    return (await aexecute(GetMessageQuery, {"id": id}, rath=rath)).message
...
def get_message(id: ID, rath: Optional[AlpakaRath] = None) -> Message:
    ...
    Returns:
        Message
    """
    return execute(GetMessageQuery, {"id": id}, rath=rath).message
...
async def asearch_messages(
    ...
    return (
        await aexecute(
            SearchMessagesQuery, {"search": search, "values": values}, rath=rath
        )
    ).options
...
async def alist_messages(
    ...
    return (
        await aexecute(
            ListMessagesQuery, {"filter": filter, "pagination": pagination}, rath=rath
        )
    ).messages
